  <?php
    ...
    $reservation = Reservation::getAllResrvation();
    $res = new visite();
                  ...
                  <div class="flex flex-wrap justify-between items-end gap-4">
                      ...
                      <div class="bg-primary/10 border border-primary/20 p-4 rounded-2xl flex items-center gap-4">
                          ...
                          <div>
                              ...
                              <p class="text-xl font-black italic"><?= 00 ?></p>
                          </div>
                      </div>
                  </div>
                                      ...
                                      <tr class="hover:bg-primary/5 transition-colors group">    
                                          ...
                                          <td class="px-6 py-4 whitespace-nowrap">
                                              <div class="flex items-center gap-3">
                                                  ...
                                                  <div class="flex flex-col">
                                                      <span class="text-sm font-bold text-text-main-light dark:text-text-main-dark uppercase"><?= $res->getNomUtilisateur() ?></span>
                                                      <span class="text-[10px] text-text-sec-light"><?= $res->getIdVisiteur()?></span>
                                                  </div>
                                              </div>
                                          </td>
                                          ...
                                          <td class="px-6 py-4">
                                              <div class="flex flex-col">
                                                  ...
                                                  <span class="text-sm font-medium text-text-main-light dark:text-text-main-dark line-clamp-1 italic"><?= $visite->getNameVisite($id) ?></span>
                                                  <span class="text-[10px] text-primary font-bold uppercase tracking-tighter"><?= $res->getIdVisite(); ?></span>
                                              </div>
                                          </td>
                                          ...
                                          <td class="px-6 py-4 whitespace-nowrap text-sm text-text-main-light dark:text-text-main-dark">
                                              ...
                                              <?= $res->getDateReservation()->format('Y-m-d H:i') ?>
                                              </div>
                                          </td>
